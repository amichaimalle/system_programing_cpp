...
void Menu::mainMenu(){
    // This function is the main menu, which called the secondary menu upon user request
...
void Menu::shopMenu(){
    // This function is the shop menu, which called the secondary menu upon user request
    printShopMenu();
    cin >> choice;
    while(choice != 4){
        switch(choice){
...
void Menu::stackMenu(){
    // This function is the stack menu, which called the secondary menu upon user request
    int Element;
    printStackMenu();
    cin >> choice;
    while(choice != 5){
...
void Menu::printStackMenu() const{
    //this function print the stack menu, called by the stackMenu
